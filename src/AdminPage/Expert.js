          ...
          {expertData.map((expert) => (
            <tr key={expert.id}>
                ...
                {editingId === expert.id ? (
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      const index = newExpertdata.findIndex(
                        (i) => i.id === expert.firstName
                      );
                      if (index !== -1) {
              ...
              <td>
                {expert.id === editingId ? (
                  <>
                    <button onClick={() => handleSaveClick(expert.id)}>
                      Save
                    </button>
